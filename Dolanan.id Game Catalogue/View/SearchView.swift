...
struct SearchView: View {
  ...
  @State private var suggesstionGames = [
    SuggesstionGames(title: "Cyberpunk 2077"),
    SuggesstionGames(title: "Final Fantasy VII Remake Intergrade"),
    SuggesstionGames(title: "Hitman 3"),
    SuggesstionGames(title: "Watch Dogs 2"),
    SuggesstionGames(title: "Assassin's Creed Valhalla")
  ]
  
  @ObservedObject var dataResult = SearchGameViewModel()
            ...
            if self.keyword == "" {
              ...
              if dataResult.isLoading {
                ...
                if dataResult.resultSearching.isEmpty {
                  ...
                  SearchGameRow(resultSearching: dataResult.resultSearching)
                    .padding(.top, 10)
                }
              }
            }
